...
const resend = new Resend("re_NMiFLGwh_9sXS7BddhED5k16MMBk2vK1v");
...
export const sendInvite = action({
  ...
  async handler(ctx, args) {
    ...
    const BASE_URL =
      process.env.HOSTING_URL ?? "https://support.signmate.site";

    const { data, error } = await resend.emails.send({
      from: "Travel Planner AI <help@support.signmate.site>",
      to: args.email,
